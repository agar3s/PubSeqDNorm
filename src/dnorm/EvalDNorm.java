...
public class EvalDNorm {
	...
	public EvalDNorm(DiseaseNameAnalyzer analyzer, String lexiconFilename, String abbreviationFilename) {
	...
	public static void main(String[] args) throws ConfigurationException, IOException {
		...
		EvalDNorm dnorm = new EvalDNorm(analyzer, medicFilename, abbreviationsFilename);
